package com.sirius.test_app.models

class DataModel(
    val image: String = "https://i.ibb.co/g3YVWD2/img-background.png",
    val logo: String = "https://i.ibb.co/W3SchmV/dota-logo.png",
    ...
    val reviews: List<ReviewModel> = listOf(
        ...
        ReviewModel(
            userImage = "https://i.ibb.co/93H93pm/J1-Hi-Ll-Tt-Wu-U.jpg",
            userName = "Katerina Morozova",
            date = "July 15, 2022",
            message =
            "“Even though I don't play Dota 2, I really want to go to the Sirius Summer Camp!”"
        )
    ),
